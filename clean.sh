...
rm /root/autodl-tmp/Trans_vocals/*
rm /root/autodl-tmp/Trans_speed_vocals/*
rm /root/autodl-tmp/Core/video-retalking/examples/audio/*
rm /root/autodl-tmp/Core/video-retalking/examples/face/*
rm /root/autodl-tmp/OUTPUT/*.wav
rm /root/autodl-tmp/OUTPUT/*.mp4
